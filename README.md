...
Correlate the personal sprint report with completed goals stated in the sprint report
Trello Card(s) that shows the completed artifact (screen shot of card)
Github code commits
https://github.com/djrybski/testsite/commits/master
